        ...
        <div className="contact-card group rounded-2xl p-6 sm:p-8 md:p-10 w-full max-w-4xl mx-auto text-left">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div>
                    ...
                    {emailAddress && (
                        <div className="bg-slate-900/70 border border-slate-700 rounded-lg p-2 flex items-center justify-between text-left">
                            <code className="text-indigo-300 text-sm break-all font-mono px-2 select-all">{emailAddress}</code>
                            <button 
                                onClick={handleCopy}
