        ...
        <div className="min-h-screen flex items-center bg-transparent pt-28 pb-12 md:pt-0 md:pb-0">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="text-center md:text-left relative z-10 row-start-1 col-start-1">
                        ...
                        <div className="mt-10 flex flex-wrap justify-center md:justify-start gap-4 fade-in-up" style={{ transitionDelay: '600ms' }}>
                            ...
                            <a href="#technologies" className="btn btn-secondary">
                                {t.hero.cta2}
                            </a>
                        </div>
                    ...
                    <div className="flex justify-center items-center row-start-1 col-start-1 md:col-start-2 fade-in-up hero-orb-container w-full max-w-[300px] h-auto aspect-square sm:max-w-[400px] md:max-w-[450px] lg:max-w-[500px] mx-auto opacity-70">
                        <AnimatedOrb />
                    </div>
                </div>
            </div>
